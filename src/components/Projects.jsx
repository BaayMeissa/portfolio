...
const Projects = () => {
  return (
    <div>
      ...
      <h1 className='mb-[-80px] mt-[100px] text-center sm:hidden sm:text-2xl text-xl px-5'>Nemmeeku Chat App</h1>
      ...
      <h1 className='mb-[-80px] mt-[100px] text-center sm:hidden sm:text-2xl text-xl px-5'>NjàmburStyle - eCommerce web application</h1>
        <div className='flex sm:flex-row flex-col items-center sm:gap-20 sm:px-32 px-8'>
            <img src="/Ecommerce-Photoroom.png" className='sm:w-[700px] w-[400px]' alt="" />
            <div className='flex flex-col gap-14'>
            <h1 className='hidden sm:block sm:text-left text-center sm:text-2xl text-xl'>NjàmburStyle - eCommerce wep application</h1>
            <p>
      ...
      <h1 className='mb-[-80px] mt-[100px] text-center sm:hidden sm:text-2xl text-xl px-5'>This portfolio</h1>
        <div className='flex sm:flex-row flex-col items-center sm:gap-20 sm:px-32 px-8'>
